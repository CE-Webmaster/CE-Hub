...
class MagicToolbox_Magic360_Block_Adminhtml_Settings_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $optionsIds = Mage::registry('magic360_options_ids');
        ...
        if($tool === null) {
            ...
            */
            ...
            Mage::register('magic360_options_ids', $optionsIds);
        ...
        foreach($helper->getParamsMap($blockId) as $group => $ids) {
            ...
            $fieldset->addType('magic360_radios', 'MagicToolbox_Magic360_Block_Adminhtml_Settings_Edit_Tab_Form_Element_Radios');
            foreach($ids as $id) {
                $config = array(
