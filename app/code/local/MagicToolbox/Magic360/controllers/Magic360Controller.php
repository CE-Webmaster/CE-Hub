...
class MagicToolbox_Magic360_Magic360Controller extends Mage_Adminhtml_Controller_Action {
    ...
    public function addAction() {
        ...
        if($data = $this->getRequest()->getPost()) {
            ...
            $defaultValues = serialize(Mage::helper('magic360/params')->getDefaultValues());
    ...
    public function saveAction() {
        ...
        if($post = $this->getRequest()->getPost()) {
            ...
            /*
            foreach($post['magic360'] as $block => $params) {
                if(is_array($params))
                foreach($params  as $paramId => $value) {
                    if(isset($post['magic360-defaults'][$block][$paramId])) {
                        unset($post['magic360'][$block][$paramId]);
                    }
                }
            }
            */
            ...
            $data = array();
            $data['value'] = serialize($post['magic360']);
