...
*
*/
class Glace_Productlabels_Block_Adminhtml_Productlabels_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
      $this->addColumn('id', array(
          'header'    => '<i class="fa fa-share"></i>&nbsp;&nbsp;'.Mage::helper('productlabels')->__('ID'),
          'align'     =>'right',
          'width'     => '50px',
          'index'     => 'id',
      ));
      ...
      $this->addColumn('name', array(
          'header'    => '<i class="fa fa-share"></i>&nbsp;&nbsp;'.Mage::helper('productlabels')->__('Title'),
          'align'     =>'left',
          'index'     => 'name',
      ));
      ...
      $this->addColumn('status', array(
          'header'    => '<i class="fa fa-share"></i>&nbsp;&nbsp;'.Mage::helper('productlabels')->__('Status'),
          'align'     => 'left',
          'width'     => '80px',
          'index'     => 'status',
          'type'      => 'options',
        ...
        $this->addColumn('action',
            array(
                'header'    =>  '<i class="fa fa-share"></i>&nbsp;&nbsp;'.Mage::helper('productlabels')->__('Action'),
                'width'     => '100',
                'type'      => 'action',
                'getter'    => 'getId',
                'actions'   => array(
