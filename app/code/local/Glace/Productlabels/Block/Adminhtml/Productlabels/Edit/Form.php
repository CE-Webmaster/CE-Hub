...
*
*/
class Glace_Productlabels_Block_Adminhtml_Productlabels_Edit_Form extends Glace_Productlabels_Block_Adminhtml_Element_Form
{
	protected function _construct()
	{
		parent::_construct();
		$this->setTemplate('glace_productlabels/edit/form.phtml');
	}
