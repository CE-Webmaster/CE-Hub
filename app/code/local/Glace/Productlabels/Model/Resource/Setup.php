...
*
*/
class Glace_Productlabels_Model_Resource_Setup extends Mage_Eav_Model_Entity_Setup
{
     /**
    ...
    {
        $entities = array(
            Glace_Productlabels_Model_Productlabels::ENTITY    => array(
                ...
                'attributes'                     => array(
                    'name'          => array(
                        ...
                        'input'              => 'text',
                        'required'           => true,
						'global'             => Glace_Productlabels_Model_Attribute::SCOPE_STORE,
                        'sort_order'         => 1
                    ),
					'image'          => array(
                        'type'               => 'varchar',
					...
					'css_class'          => array(
                        ...
                        'input'              => 'text',
                        'required'           => false,
						'note'               => 'Some class css use as default.(Bestseller Product Label: bestseller; New Product Label: new; Sale Product Label: special)',
						'global'             => Glace_Productlabels_Model_Attribute::SCOPE_STORE,
                        'sort_order'         => 5
                    ),
					'status'         => array(
					...
					'actions'         => array(
                        ...
                        'label'              => 'Actions',
                        'input'              => 'textarea',
						'global'             => Glace_Productlabels_Model_Attribute::SCOPE_GLOBAL,
                        'required'           => false,
                        'sort_order'         => 8,
						'visible'            => false
                    ),
			...
			Glace_Productlabels_Model_Css::ENTITY    => array(
