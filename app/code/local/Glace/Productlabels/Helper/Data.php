...
*
*/
class Glace_Productlabels_Helper_Data extends Mage_Core_Helper_Abstract
{
    protected $labels;
    public function resizeImage($imageName, $width=NULL, $height=NULL, $imagePath=NULL,$type)
   {
    ...
    function display($_product)
    {
        ...
        $block = new Glace_Productlabels_Block_Productlabels();
        $labelShows = array();
        ...
        if(!empty ($labelShows)){
            echo $block->addObject(array('labels'=>$labelShows,'product'=>$_product))->setTemplate('glace_productlabels/productlabels.phtml')->toHtml();
        }
