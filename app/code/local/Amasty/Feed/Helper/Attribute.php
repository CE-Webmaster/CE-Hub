...
class Amasty_Feed_Helper_Attribute extends Mage_Core_Helper_Abstract
{
    ...
    public static $_OTHER_CONDITION_MIN_PRICE = 'min_price';
    public static $_OTHER_CONDITION_MAX_PRICE = 'max_price';
    public static $_OTHER_CONDITION_FINAL_PRICE = 'final_price';
    ...
    public function getCompoundAttributes(){
        ...
        if (!$this->_compaundAttributes) {
            $this->_compaundAttributes = array(
                ...
                self::$_OTHER_CONDITION_MIN_PRICE => $hlr->__('Minimal Price'),
                self::$_OTHER_CONDITION_MAX_PRICE => $hlr->__('Maximal Price'),
                self::$_OTHER_CONDITION_FINAL_PRICE => $hlr->__('Final Price'),
    ...
    {
        $attributes = $this->getCompoundAttributes();
