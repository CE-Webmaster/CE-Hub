...
//            $this->joinField('category_id', 'catalog/category_product_index', 'category_id', 'product_id = entity_id', '{{table}}.store_id = ' . $this->getStoreId(), 'left');
    ...
    public function joinPrice($storeId){
        if (!$this->_checkJoin('price')){
            $this->joinAttribute('price', 'catalog_product/price' , 'entity_id', null, 'left', $storeId);
    ...
    protected function _productLimitationPrice($joinLeft = false)
    {
        ...
        if (!isset($fromPart['price_index'])) {
            ...
            $colls       = array('tax_class_id', 'final_price',
