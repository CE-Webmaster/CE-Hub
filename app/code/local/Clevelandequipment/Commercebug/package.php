...
class Commercebug_Packager
{
    ...
    {
        $string = '<?xml version="1.0" encoding="UTF-8"?><config><modules><Clevelandequipment_Commercebug><active>true</active><codePool>local</codePool></Clevelandequipment_Commercebug></modules></config>';
        $string = str_replace('Clevelandequipment_', $this->namespace . '_',$string);
