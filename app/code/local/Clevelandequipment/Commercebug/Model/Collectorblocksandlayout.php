...
*/
class Clevelandequipment_Commercebug_Model_Collectorblocksandlayout extends Clevelandequipment_Commercebug_Model_Observingcollector
{
    ...
    {		
        ...
        foreach($this->_blocks as $block)
        {
            ...
            if(strpos($class,'Clevelandequipment_Commercebug') === 0)
            {
                continue;
            }
