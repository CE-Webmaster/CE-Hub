...
*/
class Clevelandequipment_Commercebug_Model_Shim
{
    ...
    */    
    ...
    protected function _getNamespaceForGroup($group)
    {
        ...
        {
            case 'commercebug':
                $module = 'Clevelandequipment_Commercebug';
    ...
    {
        $full_module_name = 'Clevelandequipment_Commercebug';
    ...
    static public function getInstance()
    {
        if(!self::$_instance)
        {
            self::$_instance = new Clevelandequipment_Commercebug_Model_Shim;
        }
