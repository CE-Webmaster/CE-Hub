...
*/
abstract class Clevelandequipment_Commercebug_Model_Crossareaajax
{
    ...
    */    
    ...
    {
        $controllers = array('Clevelandequipment_Commercebug_AjaxController','Clevelandequipment_Commercebug_AdminajaxController');
        ...
        foreach($controllers as $controller)
        {
            ...
            'Clevelandequipment_Commercebug_Model_Crossareaajax','appendAction'), self::$_actionNames);
