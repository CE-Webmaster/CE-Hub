...
class Clevelandequipment_Commercebug_Block_Html extends Mage_Core_Block_Template
{	
    protected $_config;
    protected function _checkValidScriptPath($scriptPath)
    {
        $paths_to_check = array(Mage::getBaseDir('design'),Mage::getModuleDir('', 'Clevelandequipment_Commercebug'));
        $valid			= false;
    ...
    {	    	
        $module_dir = Mage::getModuleDir('', 'Clevelandequipment_Commercebug');
    ...
    protected function getConfig()
    {
        ...
        if($shim->isMage2())
        {
            #Clevelandequipment_Commercebug_Model_Shim::Log('Mage 2 Cleanup at: ' . __CLASS__ . ' ' . __LINE__);
