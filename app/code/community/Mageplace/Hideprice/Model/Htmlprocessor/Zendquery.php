 ...
 */
class Mageplace_Hideprice_Model_Htmlprocessor_Zendquery
    extends Zend_Dom_Query
    implements Mageplace_Hideprice_Model_Htmlprocessor_Interface
{
    protected $_processorName = 'mageplace_hideprice/htmlprocessor_zendquery';
