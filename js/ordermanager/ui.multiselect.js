...
$.widget("ui.multiselect", {
  options: {
	...
	_create: function() {
		...
		this.availableList = $('<ul class="available connected-list firstcol"><li class="ui-helper-hidden-accessible"></li></ul>').bind('selectstart', function(){return false;}).appendTo(this.availableContainer);
