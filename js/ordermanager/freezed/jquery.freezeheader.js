(function ($) {
    $.fn.freezeHeader = function (params) {
       ...
       // conteudoHeader = grid.find('thead');
	    conteudoHeader = grid.find('tr[class$="headings"]');
 //customized
 
 		//conteudoHeader = '<tr class="headings">'. conteudoHeader . '</tr>';
...
//customized
            tabela.append('<thead><tr class="headings">' + conteudoHeader.html() + '</tr></thead>');
            ...
            if (params && params.height !== undefined) {
                ...
                container.css("top", "35px");//customized
